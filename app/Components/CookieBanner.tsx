...
const CookieBanner = () => {
  ...
  return (
    ...
    fixed bottom-0 left-0 right-0 ${cookieConsent != null ? "hidden" : "flex"}
    px-3 md:px-4 py-3  justify-between items-center flex-col sm:flex-row gap-4 bg-gray-700
    rounded-lg shadow-text-gray-200`}>
...
<div className="flex gap-2">
    ...
    <button className="bg-gray-900 px-5 my-2 text-white rounded-lg" onClick={()=> setCookieConsent(true)}>Allow Cookies</button>
