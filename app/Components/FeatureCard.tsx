...
const FeatureCard = (props: PostMetaData) => {
  return (
    <div className="mb-16 overflow-hidden bg-black mx-4 rounded-lg shadow-lg md:shadow-sm hover:shadow-lg">
      <Link href={`/posts/${props.slug}`}>
        <div className=" h-36 w-56 lg:h-48 lg:w-96 relative pb-3/5 ">
          <Image
            loading="lazy"
       ...
       <h2 className="px-2 text-xs font-bold leading-tight text-gray-300 capitalize lg:text-xs">
        {props.title}
       </h2>
